...
const addProduct = asyncHandler(async (req, res) => {
    ...
    try {
        const { name, description, price, category, brand, quantity,countInStock } = req.fields
...
try {
    ...
    console.log(error);
    res.status(404).json({error:"Prdouct not found"})
}
...
const filerProducts=asyncHandler(async(req,res)=>{
    try {
