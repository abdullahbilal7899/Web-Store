  ...
  return (
    <div className='p-3'>
      <form onSubmit={handleSubmit} className='space-y-3'>
        ...
        <input type="text" 
        className='py-3 px-4 border rounded-lg w-full bg-gray-800 text-white placeholder-gray-400' 
...
{handleDelete && (
    ...
    focus:outilne-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50'>Delete</button>
)}
        </div>
      </form>
    </div>
