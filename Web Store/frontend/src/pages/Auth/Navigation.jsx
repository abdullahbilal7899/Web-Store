...
try {
   ...
   console.error(error) 
    ...
    return (
        <div style={{ zIndex: 999 }} className={`${showSidebar ? "hidden" : "flex"} xl:flex lg:flex md:hidden sm:hidden 
 flex-col justify-between p-4 text-white bg-black w-[4%] hover:w-[15%] h-[100vh] fixed`} id='navigation-container'>
...
<div className="flex flex-col justify-center space-y-4">
    ...
    <div className='flex items-center transition-transform hover:translate-x-2'>
...
{userInfo && (
 ...
 <path
    ...
    {dropdownOpen && userInfo && (
          <ul
            className={`absolute right-0 mr-14 space-y-1 bg-white text-gray-600  ${
          ...
          >
            ...
            <li>
              <Link to="/user-orders" className="block px-4 py-2 hover:bg-gray-300">
                My Orders
              </Link>
            </li>
            <li>
    ...
    {/* {dropdownOpen && userInfo && (
        <ul className={`absoulte right-0 mt-2 mr-14 space-y-2 bg-white text-gray-600 
            ${!userInfo.isAdmin ? '-top-20':'-top-80'}`}>
                ...
                {userInfo.isAdmin &&  (
                 ...
                 <li>
                        <Link to='/admin/profile' className='block px-4 py-2 w-full text-left hover:bg-gray-100'>
                        Profile
                        </Link>
                    </li>

                    <li>
                        <Link to='/admin/logout' onClick={logoutHandler} className='block w-full text-left px-4 py-2 hover:bg-gray-100'>
                        Logout
                        </Link>
                    </li>
            </ul>
