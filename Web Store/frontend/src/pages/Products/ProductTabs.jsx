...
<select id="rating" required value={rating} onChange={e=>setRating(e.target.value)}
    className="p-2 border rounded-lg xl:w-[40rem] mt-4 bg-gray-800 text-white placeholder-gray-400">
        ...
        <option value="5">Exceptional</option>
                   ...
                   <div className="my-2">
                    ...
                    className="p-2 border rounded-lg xl:w-[40rem] bg-gray-800 text-white placeholder-gray-400"></textarea>
                   </div>

                   <button type="submit" disabled={loadloadingProductReview} 
                   className="bg-pink-600 text-white py-2 px-4 rounded-lg">Submit</button>
                </form>
            ):(
                <p>Please <Link className="hover:underline text-pink-600" to='/login'>Sign In</Link> to write a review</p>
            )}
        </div>
    )}
    </section>   
