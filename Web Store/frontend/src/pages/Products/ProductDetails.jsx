                ...
                <div className="flex justify-between flex-wrap">
                    ...
                    {product.countInStock > 0 && (
                        <div>
                            ...
                            className="p-2 w-[6rem] rounded-lg bg-gray-800 text-white placeholder-gray-400">
...
{x+1}
                ...
                <div className="btn-container">
                    ...
                    className="bg-pink-600 text-white py-2 px-4 rounded-lg mt-4 md:mt-0">Add To Cart</button>
                </div>
            </div>
